...
public enum FilterType {
    ...
    public static ArrayList<Integer> getFilterImages() {

        ArrayList<Integer> filter_showcase = new ArrayList<>();
        filter_showcase.add(R.drawable.normal);
        filter_showcase.add(R.drawable.blur);
        filter_showcase.add(R.drawable.box_blur);
        filter_showcase.add(R.drawable.brightness);
        filter_showcase.add(R.drawable.bulge_disto);
        filter_showcase.add(R.drawable.cga_colorspage);
        filter_showcase.add(R.drawable.contrast);
        filter_showcase.add(R.drawable.crosshatch);
        filter_showcase.add(R.drawable.expossure);
        filter_showcase.add(R.drawable.filter_group_sample);
        filter_showcase.add(R.drawable.gamma);
        filter_showcase.add(R.drawable.gaussian_filtter);
        filter_showcase.add(R.drawable.gray_scals);
        filter_showcase.add(R.drawable.haletdne);
        filter_showcase.add(R.drawable.haze);
        filter_showcase.add(R.drawable.highlight);
        filter_showcase.add(R.drawable.hue);
        filter_showcase.add(R.drawable.invert);
        filter_showcase.add(R.drawable.look_up);
        filter_showcase.add(R.drawable.luminance);
        filter_showcase.add(R.drawable.luminaces);
        filter_showcase.add(R.drawable.monochr);
        filter_showcase.add(R.drawable.opacity);
        filter_showcase.add(R.drawable.pixelation);
        filter_showcase.add(R.drawable.posterize);
        filter_showcase.add(R.drawable.rgb);
        filter_showcase.add(R.drawable.saturation);
        filter_showcase.add(R.drawable.sepia);
        filter_showcase.add(R.drawable.sharp);
        filter_showcase.add(R.drawable.solarize);
        filter_showcase.add(R.drawable.solarize_copy);
        filter_showcase.add(R.drawable.swirl);
        filter_showcase.add(R.drawable.tone);
        filter_showcase.add(R.drawable.tone);
        filter_showcase.add(R.drawable.vibrance);
        filter_showcase.add(R.drawable.vignette);
        filter_showcase.add(R.drawable.weak_pixel);
        filter_showcase.add(R.drawable.white);
        filter_showcase.add(R.drawable.zoom);


        return filter_showcase;
    }
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            //  case WATERMARK:
            //     return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.watermark), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:
            ...
            //        return new GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.watermark));
            default:
                return new GlFilter();
        }
    }
    ...
    public static GlFilter getWaterMarkEffect(Context context) {
        return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.videoeffect), GlWatermarkFilter.Position.RIGHT_BOTTOM);
    }
